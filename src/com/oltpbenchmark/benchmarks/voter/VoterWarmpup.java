...
class WarmupThread extends Thread {
    ...
    public void run() {
        ...
        for (int i = start; i < end; i++) {
            ...
            try {
            	System.out.println(call.voteId+","+call.phoneNumber+","+call.contestantNumber);
				vote.warmuprun(conn, call.voteId, call.phoneNumber, call.contestantNumber, VoterConstants.MAX_VOTES, cache);
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
